...
import gradio as gr
from dotenv import \
    load_dotenv  # Tambahkan untuk mengelola environment variables
from langchain.chains import RetrievalQA
from langchain.text_splitter import CharacterTextSplitter
from langchain_community.document_loaders import PyPDFLoader
from langchain_community.embeddings import \
    HuggingFaceEmbeddings  # Ganti FakeEmbeddings dengan embeddings yang sebenarnya
...
def get_llm():
    return ChatGroq(
        ...
        temperature=1.0  # Utak atik nilai temperatur untuk mendapatkan hasil yang berbeda
    )
